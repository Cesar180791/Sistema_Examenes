...
<div class="login-wrapper">
    <form action="action.php" method="POST" id="login" enctype="multipart/form-data">
        <h1><span>Administrador</span> </h1>

        <div class="input-row">
            <span class="icon"><i class="fa fa-at"></i></span>
            <input name="usuario" id="usuario" type="text" placeholder="Correo Electronico" required />
        </div>
...
<script src="/projectModul4/admin/assets/js/main.js"></script>
