...
<main class="page-content">
    <div class="container-fluid">
        ...
        <div id="FormRegistroE">
            <div class="row">
                <div class="form-group col-md-10">
                    <form action="#" method="post" name="crearExamen" id="crearExamen" enctype="multipart/form-data">
                        <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" data-parent="#accordion">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                        <div class="col-12">
                                                            <!--Id De Sesion-->
                                                            <input value="<?php echo $_SESSION['user']?>" type="text" class="form-control" id="frmIdDocente"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <input type="text" class="form-control" id="frmNombreExamen"
                                                                placeholder="Nombre examen" pattern="[A-Z a-z]+" required><br>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer text-center">
                                <input value="Editar" type="submit" class="btn btn-outline-primary me-2" name="Editar"
                                    id="Editar"></input>
                                <button id="backTabla2E" class="btn btn-outline-primary"><i
                                        class="fas fa-undo-alt"></i></button>
                            </div>
                        </div>
                    </form>
...
<script src="./assets/js/AdminTablaExamenes.js"></script>
<script src="./assets/js/ajaxRegiExamenes.js"></script>
